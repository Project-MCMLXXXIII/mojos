...
task(
  ...
  console.log(`Mojos DAO Executor address: ${contracts.MojosDAOExecutor.instance.address}`);
  console.log(`Mojos DAO Proxy address: ${contracts.MojosDAOProxy.instance.address}`);
