...
import { mojosToken, mojosDescriptor__factory as mojosDescriptorFactory } from '../../typechain';
...
describe('mojos Governance', () => {
  let snapshotId: number;
  let token: mojosToken;
  let tokenCallFromGuy: mojosToken;
  let tokenCallFromDeployer: mojosToken;
  ...
  before(async () => {
    ...
    domain = Domain('mojos', token.address, await chainId());
