...
import {
  ...
  useQueueProposal,
  Vote,
} from '../../wrappers/mojosDao';
import { useUserVotesAsOfBlock } from '../../wrappers/mojosToken';
          ...
          <>
            {showBlockRestriction && !hasVoted && (
              <Alert variant="secondary" className={classes.blockRestrictionAlert}>
                Only MOJO votes that were self delegated or delegated to another address before
